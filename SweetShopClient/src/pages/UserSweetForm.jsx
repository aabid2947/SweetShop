...
import { useCreateSweetByUserMutation } from '../features/api/apiSlice';
import { ArrowLeft, Plus, X, ImagePlus, Info } from 'lucide-react';

const UserSweetForm = () => {
  const navigate = useNavigate();
  const [createSweetByUser, { isLoading, error }] = useCreateSweetByUserMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createSweetByUser(cleanedData).unwrap();
      navigate('/sweets');
    } catch (err) {
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Add Your Sweet</h1>
              <p className="text-gray-600 mt-1">Share your sweet creation with the community</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Alert className="mb-6 border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            Your sweet will be reviewed before appearing in the shop. Featured status is managed by admins.
          </AlertDescription>
        </Alert>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Homemade Chocolate Fudge"
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Tell us about your sweet creation..."
                  rows={3}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Your Sweet Brand"
                  />
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <Label>Basic Nutrition (optional)</Label>
          ...
          <div className="flex gap-4">
            ...
            >
              {isLoading ? 'Submitting...' : 'Submit Sweet'}
            </Button>
            <Button
              type="button"
              variant="outline"
